...
//         }
        ...
        stage('Build and push docker image') {
            steps {
                container('docker') {
                    sh '''
                            docker build --tag shopizer-admin:${BUILD_NUMBER} -f Dockerfile-all .
                            docker tag shopizer-admin:${BUILD_NUMBER} nexus01.evizi.com:8123/shopizer-admin:${BUILD_NUMBER}
                            docker push nexus01.evizi.com:8123/shopizer-admin:${BUILD_NUMBER}
                        '''
                }
            }
        }
